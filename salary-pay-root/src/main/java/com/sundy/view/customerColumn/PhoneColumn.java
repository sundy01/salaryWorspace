...
public class PhoneColumn extends AbstractCellEditor implements TableCellEditor, TableCellRenderer{
	...
	public Object getCellEditorValue() {
		...
		try{
		    ...
		    if(StringUtils.hasText(phoneText)){
		    	  ...
		    	  if(!m.matches()){
		    		  JOptionPane.showConfirmDialog(null, "输入的数据有误,请输入正确的手机号","格式错误",JOptionPane.ERROR_MESSAGE); 
		    		  phoneText=tempValue;
		    	  }
		    }
