...
public class EmployeeFinishClotheWriterPanel extends JFrame {
	private static final Logger log=Logger.getLogger(EmployeeFinishClotheWriterPanel.class);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployeeFinishClotheWriterPanel frame = new EmployeeFinishClotheWriterPanel();
	 ...
	 * Create the frame.
	 */
	public EmployeeFinishClotheWriterPanel() {
		setResizable(false);
